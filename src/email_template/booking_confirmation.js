const { HOTEL_NAME, HOTEL_LOCATION, HOTEL_AREA } = require("../utils/constants");
...
<body border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#F7F7F7" style="margin: 0;">
        ...
        <table class="content" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#F7F7F7" style="width: 600px; max-width: 600px;">
          <tr>
            <td width="33%" valign="middle" style="text-align:left; padding:20px 0 10px 0;">
              <a href="https://www.aspenl.com/assets/ASPENLOGO-819a2574.jpg">
                <img src="https://www.aspenl.com/assets/ASPENLOGO-819a2574.jpg" width="130" height="76" border="0" alt="ASPEN GRAND HOTELS" style="width:130px; height:76px;"  />
              </a>
            </td>
    ...
    <tr>
      <td>
        ...
        Hi ${userName},
                        ...
                        <p style="color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; " class="">Your reservation request for ${HOTEL_NAME}, ${HOTEL_AREA} has been confirmed. Please review the details of your booking.</p>
                         ...
                         <table width="100%" border="2" cellspacing="0" cellpadding="0" style="margin-top: 12px; margin-bottom: 12px; margin: 24px 0; color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif;" 
                          ...
                          <tr>
                            <td style="padding:20px 20px 0px ; font-weight:700; font-size: 25px; ">
                              Itinerary <br><p style="padding-top:0px; font-weight:700; font-size: 12px; ">Booking Confirmation Code: ${bookingCode}</p>
                           
                            </td>

                        </a></td></tr>
                           <tr> <td style="padding:20px 20px 10px ; font-weight:700; font-size: 18px; ">${HOTEL_NAME} <p style="padding-top:0px; font-weight:700; font-size: 12px; ">Rooms: ${noOfRooms} - ${roomType} - ${totalGuests} Guests</p></td>
  ...
  <tr>
    ...
    <td style="  padding:20px 20px 0px 30px ; font-weight:700; font-size: 14px;">Depart</td>
                             ...
                             </table></td></tr><tr><td  style="padding:5px 5px 0px 20px; font-weight:700; font-size: 12px; ">${HOTEL_LOCATION}</td></tr><tr><td style="width: 100% !important; max-width: 480px !important; height: auto !important;"><a href="" target="new">
                        </a></td></tr> 
                           <tr><td>
    ...
    <td style=" colspan=2; padding:20px 20px 5px 20px ; font-weight:300; font-size: 14px;">$ ${pricePerNight} x ${noOfRooms} Rooms x ${noOfNights} Nights </td><td></td>
    <td style="  padding:20px 20px 5px 30px ; font-weight:300; font-size: 14px;">$ ${totalBeforeTax}</td>
                             
  </tr>
                              
    <td style=" colspan=2; padding:5px 20px 10px 20px ; font-weight:400; font-size: 14px;">All Applicable Taxes </td><td></td>
    <td style="  padding:5px 20px 10px 30px ; font-weight:400; font-size: 14px;">$ ${taxAmount}</td>
     <tr>    <td style=" colspan=2; padding:5px 20px 10px 20px ; font-weight:700; font-size: 14px; color:#000">Grand Total </td><td></td>
       <td  style=" padding:5px 20px 10px 30px ; font-weight:700; font-size: 14px; color:#000;">$ ${totalAfterTax}</td></tr>  <tr>    <td style=" colspan=2; padding:5px 20px 10px 20px ; font-weight:700; font-size: 14px;">Payment Mode </td><td></td>
       <td  style=" padding:5px 20px 10px 30px ; font-weight:700; font-size: 14px; ">Pay @ Hotel</td></tr>                        
    ...
    <td style=" colspan=2; padding:20px 20px 5px 20px ; font-weight:300; font-size: 14px;">${guestName}</td><td></td>
    <td style="  padding:20px 20px 5px 30px ; font-weight:300; font-size: 14px;">${guestEmail}</td>
                       ...
                       <!--   <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 12px; margin-bottom: 12px; margin: 24px 0">
                        ...
                        <p style="color: #666666; font-weight: 400; font-size: 17px;  font-family: 'Helvetica neue', Helvetica, arial, sans-serif; margin-bottom: 6px; margin-top: 10px;">${HOTEL_NAME}</p>
                      </td>
                    </tr>
                  </td>
                </tr>
